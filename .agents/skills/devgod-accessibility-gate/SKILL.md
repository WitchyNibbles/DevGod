---
name: devgod-accessibility-gate
description: Use when UI work needs an accessibility-focused verification pass, especially before QA or release approval for visible interface changes.
---
...
1. Check semantics first:
   ...
   - labels
   - button/link intent
2. Check interaction next:
   - keyboard reachability
   - focus visibility
   - dialog and menu behavior
   - error and validation messaging
3. Check visual access:
   - contrast
   - text resizing resilience
   - touch target size
