...
6. When the optional Grafana MCP server is configured, use Grafana logs as advisory evidence to confirm failure timing, affected services, and counter-evidence before patching.
