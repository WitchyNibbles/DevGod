...
3. Check:
   - did the right skill trigger
   - did it produce the expected workflow steps
   - did it avoid the wrong shortcuts
...
- do not use one giant subjective grade when smaller checks are possible
