...
2. Identify the authoritative evidence:
   - runtime records
   - shipped rules or templates
   - operator docs
   - review artifacts
...
- do not assume compliance because the code is clean
