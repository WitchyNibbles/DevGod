...
7. For each task packet, include owner role, completion standard, required specialists, quality gates, scope, acceptance criteria, verification, and review gates.
...
9. Ensure the plan or task packet names the same current task id used by `.devgod/ACTIVE` and the intake brief.
