...
function buildModernizationProofSeedTaskPacket(taskId: string): TaskPacketInput {
  return {
    ...
    dependencies: [],
    allowedWriteScope: [".devgod/work", "runtime://authoritative-state"],
...
export async function executeSeedModernizationProofCommandFromArgs(
  ...
  if (!workspaceSlug || !projectSlug) {
    throw new Error("seed-modernization-proof requires DEVGOD_WORKSPACE_SLUG and DEVGOD_PROJECT_SLUG or explicit flags");
  }
