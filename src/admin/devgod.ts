...
function printUsage(): void {
  process.stdout.write(
    [
      ...
      "",
      "Runtime commands:",
      "  status | coverage | gaps | checkpoint | resume | workflow-proof | seed-workflow-proof | advance-active-task | daemon | supervisor | supervisor-history | ops | loop | recover | report | plan-context | export-docs | github-dispatch",
