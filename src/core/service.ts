...
function isProvenancedSearchResult(result: SearchMemoryResult): boolean {
...
function annotateConflictSignals(results: readonly SearchMemoryResult[]): SearchMemoryResult[] {
