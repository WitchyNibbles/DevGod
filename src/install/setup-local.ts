...
async function main(): Promise<void> {
  ...
  if (process.platform === "win32") {
    const targetScript = (await fileExists(path.join(targetRoot, "scripts", "devgod-setup.ps1")))
      ? path.join(targetRoot, "scripts", "devgod-setup.ps1")
      : path.join(targetRoot, "scripts", "setup-devgod.ps1");
